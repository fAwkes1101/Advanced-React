...
class App extends React.Component {
    ...
    /*Console:
        When line 35 was used instead of line 4 for pre populating state.
        First render() method run then componentDidUpdate() which leads to
        state change that results in re-render() that invokes componentDidUpdate()
        ›Render
        ›Mount
        ›Render
        ›Update
    -------------------------------------------------------------------------------
        When line 4 used istead of line 35. Line 4 checks if there is someting
        present in formData key of localStorage if it is null/undefined it sets the 
        default state else prepoluates the state with formData from localStorage.
        ›Render
        ›Mount
    */
